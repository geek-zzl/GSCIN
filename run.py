...
parser.add_argument('--model_id', type=str, default='PEMS03', help='model id'
                    # , required=True
                    )
...
parser.add_argument('--enc_in', type=int, default=358, help='encoder input size')
parser.add_argument('--dec_in', type=int, default=358, help='decoder input size')
parser.add_argument('--c_out', type=int, default=358, help='output size')
...
parser.add_argument('--des', type=str, default='Exp 01 test code ', help='exp description')
